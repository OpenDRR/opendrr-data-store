...
params_file = "Hazus_Consequence_Parameters_3.7.2c.xlsx"
    ...
    for rlzi in range(num_rlzs):
        ...
        with open(filename, 'w') as f:
            ...
            for asset in tqdm(assetcol):
                ...
                sc_Displ30 = asset["occupants_night"] if recovery_time > 30 and recovery_time < 90 else 0
                sc_Displ90 = asset["occupants_night"] if recovery_time > 90 and recovery_time < 180 else 0
                sc_Displ180 = asset["occupants_night"] if recovery_time > 180 and recovery_time < 360 else 0
                sc_Displ360 = asset["occupants_night"] if recovery_time > 360 else 0
                sc_BusDispl30 = asset["occupants_day"] if recovery_time > 30 and recovery_time < 90 else 0
                sc_BusDispl90 = asset["occupants_day"] if recovery_time > 90 and recovery_time < 180 else 0
                sc_BusDispl180 = asset["occupants_day"] if recovery_time > 180 and recovery_time < 360 else 0
