-- script to generate cd/ed structural mean - b0, r1
...
psra_{prov}.psra_{prov}_ed_dmg_q05_b0,psra_{prov}.psra_{prov}_ed_dmg_q05_r1,psra_{prov}.psra_{prov}_ed_dmg_mean CASCADE;
...
-- create cd table r1
CREATE TABLE psra_{prov}.psra_{prov}_cd_dmg_mean_r1(
PRIMARY KEY (asset_id),
asset_id varchar, 
"BldEpoch" varchar,
"BldgType" varchar,
...
-- import exposure from csv
COPY psra_{prov}.psra_{prov}_cd_dmg_mean_r1(asset_id,"BldEpoch","BldgType","EqDesLev","GenOcc","GenType","LandUse","OccClass","SAC","SSC_Zone","SauidID",adauid,cdname,cduid,csdname,csduid,dauid,ername,eruid,fsauid,prname,
pruid,sauid,taxonomy,lon,lat,structural_no_damage,structural_slight,structural_moderate,structural_extensive,structural_complete)
    FROM '/usr/src/app/cDamage/{prov}/cD_{prov}_dmg-mean_r1.csv'
        WITH 
          DELIMITER AS ','
          CSV ;


-- combine cd b0 and r1 table
...
INNER JOIN psra_{prov}.psra_{prov}_cd_dmg_mean_r1 b ON a.asset_id = b.asset_id
);
...
-- import exposure from csv
COPY psra_{prov}.psra_{prov}_ed_dmg_q05_b0(asset_id,"BldEpoch","BldgType","EqDesLev","GenOcc","GenType","LandUse","OccClass","OccType","SAC","SSC_Zone","SS_Region","Sauid_km2",adauid,cdname,cduid,csdname,csduid,dauid,ername,eruid,fsauid,prname,
pruid,sauid,taxonomy,lon,lat,structural_no_damage,structural_slight,structural_moderate,structural_extensive,structural_complete)
...
-- import exposure from csv
COPY psra_{prov}.psra_{prov}_ed_dmg_q05_r1(asset_id,"BldEpoch","BldgType","EqDesLev","GenOcc","GenType","LandUse","OccClass","OccType","SAC","SSC_Zone","SS_Region","Sauid_km2",adauid,cdname,cduid,csdname,csduid,dauid,ername,eruid,fsauid,prname,
pruid,sauid,taxonomy,lon,lat,structural_no_damage,structural_slight,structural_moderate,structural_extensive,structural_complete)
...
-- import exposure from csv
COPY psra_{prov}.psra_{prov}_ed_dmg_q95_b0(asset_id,"BldEpoch","BldgType","EqDesLev","GenOcc","GenType","LandUse","OccClass","OccType","SAC","SSC_Zone","SS_Region","Sauid_km2",adauid,cdname,cduid,csdname,csduid,dauid,ername,eruid,fsauid,prname,
pruid,sauid,taxonomy,lon,lat,structural_no_damage,structural_slight,structural_moderate,structural_extensive,structural_complete)
...
-- import exposure from csv
COPY psra_{prov}.psra_{prov}_ed_dmg_q95_r1(asset_id,"BldEpoch","BldgType","EqDesLev","GenOcc","GenType","LandUse","OccClass","OccType","SAC","SSC_Zone","SS_Region","Sauid_km2",adauid,cdname,cduid,csdname,csduid,dauid,ername,eruid,fsauid,prname,
pruid,sauid,taxonomy,lon,lat,structural_no_damage,structural_slight,structural_moderate,structural_extensive,structural_complete)
...
DROP TABLE IF EXISTS psra_{prov}.psra_{prov}_cd_dmg_mean_b0, psra_{prov}.psra_{prov}_cd_dmg_mean_r1, psra_{prov}.psra_{prov}_ed_dmg_mean_b0, psra_{prov}.psra_{prov}_ed_dmg_mean_r1,
