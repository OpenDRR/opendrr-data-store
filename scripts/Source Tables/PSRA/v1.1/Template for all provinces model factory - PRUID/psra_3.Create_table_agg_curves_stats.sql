...
-- import exposure from csv
COPY psra_{prov}.psra_{prov}_agg_curves_stats_r1(return_period,stat,loss_type,fsauid,"GenOcc","GenType",loss_value,loss_ratio,annual_frequency_of_exceedence)
