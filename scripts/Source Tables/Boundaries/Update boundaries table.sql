...
ALTER TABLE boundaries."SAUID_HexGrid_1km_intersect" DROP CONSTRAINT IF EXISTS "SAUID_HexGrid_1km_intersect_pkey";
ALTER TABLE boundaries."SAUID_HexGrid_1km_intersect" ADD PRIMARY KEY ("gridid_1","sauid");
CREATE INDEX IF NOT EXISTS sauid_hexgrid_5km_sauid_idx ON boundaries."SAUID_HexGrid_5km_intersect"("gridid_1","sauid");
