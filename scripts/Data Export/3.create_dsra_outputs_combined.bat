...
dsra_sim9p0_cascadiainterfacebestfault, ^
dsra_acm7p0_georgiastraitfault, ^
dsra_scm7p5_valdesbois) DO ogr2ogr -f "gpkg" D:\Workspace\data\view_outputs\all_indicators\earthquake_scenarios\%%x_shakemap_hexgrid_1km.gpkg PG:"host=localhost user=postgres dbname=opendrr password=admin port=5433" -sql "SELECT * FROM results_%%x.%%x_sm_hg_1" -nln %%x_shakemap_hexgrid_1km
...
dsra_sim9p0_cascadiainterfacebestfault, ^
dsra_acm7p0_georgiastraitfault, ^
dsra_scm7p5_valdesbois) DO ogr2ogr -f "gpkg" D:\Workspace\data\view_outputs\all_indicators\earthquake_scenarios\%%x_shakemap_hexgrid_1km_uc.gpkg PG:"host=localhost user=postgres dbname=opendrr password=admin port=5433" -sql "SELECT * FROM results_%%x.%%x_sm_hg_1_uc" -nln %%x_shakemap_hexgrid_1km_uc
...
dsra_sim9p0_cascadiainterfacebestfault, ^
dsra_acm7p0_georgiastraitfault, ^
dsra_scm7p5_valdesbois) DO ogr2ogr -f "gpkg" D:\Workspace\data\view_outputs\all_indicators\earthquake_scenarios\%%x_shakemap_hexgrid_5km.gpkg PG:"host=localhost user=postgres dbname=opendrr password=admin port=5433" -sql "SELECT * FROM results_%%x.%%x_sm_hg_5" -nln %%x_shakemap_hexgrid_5km
...
dsra_sim9p0_cascadiainterfacebestfault, ^
dsra_acm7p0_georgiastraitfault, ^
dsra_scm7p5_valdesbois) DO ogr2ogr -f "gpkg" D:\Workspace\data\view_outputs\all_indicators\earthquake_scenarios\%%x_shakemap_hexgrid_5km_uc.gpkg PG:"host=localhost user=postgres dbname=opendrr password=admin port=5433" -sql "SELECT * FROM results_%%x.%%x_sm_hg_5_uc" -nln %%x_shakemap_hexgrid_5km_uc
...
dsra_sim9p0_cascadiainterfacebestfault, ^
dsra_acm7p0_georgiastraitfault, ^
dsra_scm7p5_valdesbois) DO ogr2ogr -f "gpkg" D:\Workspace\data\view_outputs\all_indicators\earthquake_scenarios\%%x_shakemap_hexgrid_10km.gpkg PG:"host=localhost user=postgres dbname=opendrr password=admin port=5433" -sql "SELECT * FROM results_%%x.%%x_sm_hg_10" -nln %%x_shakemap_hexgrid_10km
...
dsra_sim9p0_cascadiainterfacebestfault, ^
dsra_acm7p0_georgiastraitfault, ^
dsra_scm7p5_valdesbois) DO ogr2ogr -f "gpkg" D:\Workspace\data\view_outputs\all_indicators\earthquake_scenarios\%%x_shakemap_hexgrid_25km_uc.gpkg PG:"host=localhost user=postgres dbname=opendrr password=admin port=5433" -sql "SELECT * FROM results_%%x.%%x_sm_hg_25_uc" -nln %%x_shakemap_hexgrid_25km_uc
...
dsra_sim9p0_cascadiainterfacebestfault, ^
dsra_acm7p0_georgiastraitfault, ^
dsra_scm7p5_valdesbois) DO ogr2ogr -f "gpkg" D:\Workspace\data\view_outputs\all_indicators\earthquake_scenarios\%%x_shakemap_hexgrid_50km_uc.gpkg PG:"host=localhost user=postgres dbname=opendrr password=admin port=5433" -sql "SELECT * FROM results_%%x.%%x_sm_hg_50_uc" -nln %%x_shakemap_hexgrid_50km_uc
...
dsra_sim9p0_cascadiainterfacebestfault, ^
dsra_acm7p0_georgiastraitfault, ^
dsra_scm7p5_valdesbois) DO ogr2ogr -f "gpkg" D:\Workspace\data\view_outputs\all_indicators\earthquake_scenarios\%%x_shakemap_hexgrid_100km_uc.gpkg PG:"host=localhost user=postgres dbname=opendrr password=admin port=5433" -sql "SELECT * FROM results_%%x.%%x_sm_hg_100_uc" -nln %%x_shakemap_hexgrid_100km_uc
...
@REM ) DO ogr2ogr -f "gpkg" D:\Workspace\data\view_outputs\all_indicators\earthquake_scenarios\scenario_info\%%x.gpkg PG:"host=localhost user=postgres dbname=opendrr password=admin port=5433" -sql "SELECT * FROM dsra.%%x" -nln %%x
