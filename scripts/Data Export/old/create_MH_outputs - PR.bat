...
nhsl_hazard_threat_wf_threat_to_people_s,nhsl_hazard_threat_wf_threat_wf_hazard_s) DO "C:\OSGeo4W64\bin\ogr2ogr.exe" -f "GeoJSON" D:\workspace\data\view_outputs\nhsl\multi_hazard\%%x_BC.geojson PG:"host=localhost user=postgres dbname=opendrr_10302020 password=password" -sql "SELECT * FROM results_nhsl_hazard_threat.%%x WHERE pruid = '59'"
...
nhsl_hazard_threat_ls_threat_to_people_s,nhsl_hazard_threat_mh_mh_intensity_s,nhsl_hazard_threat_mh_threat_to_assets_s,nhsl_hazard_threat_mh_threat_to_buildings_s,nhsl_hazard_threat_mh_threat_to_people_s,nhsl_hazard_threat_ts_threat_to_assets_s,
nhsl_hazard_threat_ts_threat_to_buildings_s,nhsl_hazard_threat_ts_threat_to_people_s,nhsl_hazard_threat_ts_threat_ts_inundation_hazard_s,nhsl_hazard_threat_wf_threat_to_assets_s,nhsl_hazard_threat_wf_threat_to_buildings_s,
nhsl_hazard_threat_wf_threat_to_people_s,nhsl_hazard_threat_wf_threat_wf_hazard_s) DO "C:\OSGeo4W64\bin\ogr2ogr.exe" -f "gpkg" D:\workspace\data\view_outputs\nhsl\multi_hazard\%%x_BC.gpkg PG:"host=localhost user=postgres dbname=opendrr_10302020 password=password" -sql "SELECT * FROM results_nhsl_hazard_threat.%%x WHERE pruid = '59'"
