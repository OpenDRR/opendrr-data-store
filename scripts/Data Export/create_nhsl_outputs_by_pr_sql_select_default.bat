...
nhsl_physical_exposure_all_indicators_s_yt) DO ogr2ogr -f "gpkg" D:\Workspace\data\view_outputs\all_indicators\province\sql_select\physical_exposure\%%x.gpkg PG:"host=localhost user=postgres dbname=opendrr_allscenarios password=admin"  -sql "SELECT * FROM results_nhsl_physical_exposure.%%x"
...
nhsl_risk_dynamics_all_indicators_yt) DO ogr2ogr -f "gpkg" D:\Workspace\data\view_outputs\all_indicators\province\sql_select\risk_dynamics\%%x.gpkg PG:"host=localhost user=postgres dbname=opendrr_allscenarios password=admin" -sql "SELECT * FROM results_nhsl_risk_dynamics.%%x"
...
nhsl_hazard_threat_all_indicators_s_yt) DO ogr2ogr -f "gpkg" D:\Workspace\data\view_outputs\all_indicators\province\sql_select\multi_hazard_threat\%%x.gpkg PG:"host=localhost user=postgres dbname=opendrr_allscenarios password=admin" -sql "SELECT * FROM results_nhsl_hazard_threat.%%x"
PAUSE
