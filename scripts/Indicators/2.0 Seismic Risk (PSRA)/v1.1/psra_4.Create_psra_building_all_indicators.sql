...
CAST(CAST(ROUND(CAST(c.structural_no_damage_r1 AS NUMERIC),6) AS FLOAT) AS NUMERIC) AS "cD_None_r1",
CAST(CAST(ROUND(CAST((c.structural_no_damage_r1/a.number) AS NUMERIC),6) AS FLOAT) AS NUMERIC) AS "cDr_None_r1",

CAST(CAST(ROUND(CAST(c.structural_slight_r1 AS NUMERIC),6) AS FLOAT) AS NUMERIC) AS "cD_Slight_r1",
CAST(CAST(ROUND(CAST((c.structural_slight_r1/a.number) AS NUMERIC),6) AS FLOAT) AS NUMERIC) AS "cDr_Slight_r1",

CAST(CAST(ROUND(CAST(c.structural_moderate_r1 AS NUMERIC),6) AS FLOAT) AS NUMERIC) AS "cD_Moderate_r1",
CAST(CAST(ROUND(CAST((c.structural_moderate_r1/a.number) AS NUMERIC),6) AS FLOAT) AS NUMERIC) AS "cDr_Moderate_r1",

CAST(CAST(ROUND(CAST(c.structural_extensive_r1 AS NUMERIC),6) AS FLOAT) AS NUMERIC) AS "cD_Extensive_r1",
CAST(CAST(ROUND(CAST((c.structural_extensive_r1/a.number) AS NUMERIC),6) AS FLOAT) AS NUMERIC) AS "cDr_Extensive_r1",

CAST(CAST(ROUND(CAST(c.structural_complete_r1 AS NUMERIC),6) AS FLOAT) AS NUMERIC) AS "cD_Complete_r1",
CAST(CAST(ROUND(CAST((c.structural_complete_r1/a.number) AS NUMERIC),6) AS FLOAT) AS NUMERIC) AS "cDr_Complete_r1",
...
CAST(CAST(ROUND(CAST((occupants_b0/0.00001) AS NUMERIC),6) AS FLOAT) AS NUMERIC) AS "eC_Fatality_b0",
CAST(CAST(ROUND(CAST(COALESCE(occupants_b0/NULLIF(a.transit,0),0)/0.00001 AS NUMERIC),6) AS FLOAT) AS NUMERIC) AS "eCr_Fatality_b0",

-- 2.3.1 Life Safety - r1
CAST(CAST(ROUND(CAST(occupants_r1/0.00001 AS NUMERIC),6) AS FLOAT) AS NUMERIC) AS "eC_Fatality_r1",
CAST(CAST(ROUND(CAST(COALESCE(occupants_r1/NULLIF(a.transit,0),0)/0.00001 AS NUMERIC),6) AS FLOAT) AS NUMERIC) AS "eCr_Fatality_r1",
