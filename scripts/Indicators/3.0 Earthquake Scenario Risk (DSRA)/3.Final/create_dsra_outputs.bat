...
dsra_sim6p8_cr2022_scenario_hazard_shakemap_intensity_b,dsra_sim6p8_cr2022_scenario_hazard_shakemap_intensity_s) DO "C:\OSGeo4W64\bin\ogr2ogr.exe" -f "GeoJSON" D:\workspace\data\view_outputs\%%x.geojson PG:"host=localhost user=postgres dbname=oq_sandbox_new_exposure password=password" results_dsra_sim6p8_cr2022.%%x

REM Geopackage Shapefile export
FOR %%x IN (dsra_sim6p8_cr2022_affected_people_casualties_b,dsra_sim6p8_cr2022_affected_people_casualties_s,dsra_sim6p8_cr2022_affected_people_social_disruption_b,dsra_sim6p8_cr2022_affected_people_social_disruption_s,dsra_sim6p8_cr2022_building_damage_damage_state_b,
dsra_sim6p8_cr2022_building_damage_damage_state_s,dsra_sim6p8_cr2022_building_damage_recovery_b,dsra_sim6p8_cr2022_building_damage_recovery_s,dsra_sim6p8_cr2022_economic_security_economic_loss_b,dsra_sim6p8_cr2022_economic_security_economic_loss_s,
dsra_sim6p8_cr2022_scenario_hazard_shakemap_intensity_b,dsra_sim6p8_cr2022_scenario_hazard_shakemap_intensity_s) DO "C:\OSGeo4W64\bin\ogr2ogr.exe" -f "gpkg" D:\workspace\data\view_outputs\%%x.gpkg PG:"host=localhost user=postgres dbname=oq_sandbox_new_exposure password=password" results_dsra_sim6p8_cr2022.%%x
