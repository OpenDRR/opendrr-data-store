...
DROP VIEW IF EXISTS results_dsra_idm6p8_jdfpathways.dsra_idm6p8_jdfpathways_all_indicators_b CASCADE;
CREATE VIEW results_dsra_idm6p8_jdfpathways.dsra_idm6p8_jdfpathways_all_indicators_b AS 
...
LEFT JOIN gmf.shakemap_idm6p8_jdfpathways_metrovan_building_xref e ON c.id = e.id
