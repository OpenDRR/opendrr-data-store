...
-- test aggregation to hexbin grids
...
FROM results_nhsl_hazard_threat.nhsl_hazard_threat_all_indicators_s_tbl a
LEFT JOIN boundaries."SAUID_HexGrid" b ON a."Sauid" = CAST(b.sauid AS VARCHAR)
...
FROM results_nhsl_hazard_threat.nhsl_hazard_threat_all_indicators_s_tbl a
LEFT JOIN boundaries."SAUID_HexGrid" b ON a."Sauid" = CAST(b.sauid AS VARCHAR)
LEFT JOIN boundaries."HexGrid_25km" c ON b.gridid_25 = c.gridid25
...
FROM results_nhsl_hazard_threat.nhsl_hazard_threat_all_indicators_s_tbl a
LEFT JOIN boundaries."SAUID_HexGrid" b ON a."Sauid" = CAST(b.sauid AS VARCHAR)
LEFT JOIN boundaries."HexGrid_50km" c ON b.gridid_50 = c.gridid50
